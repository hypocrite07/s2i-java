...
This Source-to-Image Builder let's you create projects targetting Java OpenJDK 11 (see fork/java([1-9](\.[0-9])?) for  the particular jdk version) and built with:
...
* *JVM_OPTIONS*: Options to pass to *java ${JVM_OPTIONS} -jar app.jar*
